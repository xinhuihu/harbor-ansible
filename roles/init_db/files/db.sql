...
insert into user (user_id, username, email, password, realname, comment, deleted, sysadmin_flag, creation_time, update_time) values 
(1, 'admin', 'admin@example.com', '', 'system admin', 'admin user',0, 1, NOW(), NOW()),
(2, 'anonymous', 'anonymous@example.com', '', 'anonymous user', 'anonymous user', 1, 0, NOW(), NOW());
...
insert into project (project_id, owner_id, name, creation_time, update_time) values 
(1,1, 'library', NOW(), NOW());
...
insert into project_member (id,project_id, entity_id, role, entity_type) values
(1,1, 1, 1, 'u');
